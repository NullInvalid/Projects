...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2023 at 04:06 PM
...
--
-- Table structure for table `hrsdaysworked`
--

CREATE TABLE `hrsdaysworked` (
  `id` int(12) NOT NULL,
  `emp_code` varchar(255) DEFAULT NULL,
  `total_hrs` int(12) DEFAULT NULL,
  `total_days` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `hrsdaysworked`
--

INSERT INTO `hrsdaysworked` (`id`, `emp_code`, `total_hrs`, `total_days`) VALUES
(2, 'am29', 40, 5),
(13, 'jha28', 2, 0.25);
...
INSERT INTO `timeinout` (`id`, `emp_code`, `empName`, `time_in`, `time_out`, `hours_rendered`, `date`) VALUES
(8, 'cg4', 'Joan Selvano Geasin', '08:35:36 PM', '11:35:36 PM', 3, '01-16-2023'),
(12, 'kp2', 'Katy Kim Parey', '08:59:29 PM', '08:59:34 PM', 0, '01-16-2023'),
(13, 'jt17', 'Kobe James Bryant', '09:02:02 PM', '09:02:05 PM', 0, '01-16-2023'),
(14, 'jf30', 'Joan Selvano Geasin', '09:07:58 PM', '09:08:07 PM', 0, '01-16-2023'),
(16, 'am29', 'Anna Lopez Malvas', '08:19:43 PM', '08:41:30 PM', 0, '01-17-2023'),
(17, 'jha28', 'Jharen Lacios Delmez', '09:50:54 PM', '11:02:01 PM', 2, '01-17-2023');
...
--
-- Indexes for table `hrsdaysworked`
--
ALTER TABLE `hrsdaysworked`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `emp_code` (`emp_code`);
...
--
-- AUTO_INCREMENT for table `hrsdaysworked`
--
ALTER TABLE `hrsdaysworked`
